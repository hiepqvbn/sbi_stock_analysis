...
from utils.analysis_utils import analyze_stock_performance, record_stock_split_adjustments, get_stock_current_price
...
def update_analysis(stock_code, expected_price):
    ...
    metrics = html.Div([
        ...
        html.Div(f"Names used: {perf['stock_names']}  Current Price: {current_price:,.1f} Yen"),
        html.Ul([
            html.Li(
